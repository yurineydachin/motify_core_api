...
type Handler struct {
	...
	AppName    string // X-LZD-App-Name header value
	AppVersion string // X-LZD-App-Version header value
	Node       string // X-LZD-Node header value

	DebugAvailable bool // Swagger UI will provide a button to send X-LZD-Debug: 1
